...
Section "MainSection" SEC01
  ...
  File "${ROOT_PATH}\lib\opencsv-2.2.jar"
  ...
  File "${ROOT_PATH}\lib\jsoup-1.4.1.jar"
...
Section Uninstall
  ...
  Delete "$INSTDIR\lib\jsoup-1.4.1.jar"
  ...
  Delete "$INSTDIR\lib\opencsv-2.2.jar"
...
!define JRE_URL "http://javadl.sun.com/webapps/download/AutoDL?BundleId=44457" ;Version 6 Update 23
