...
public class EventLogMessage {
	...
	public enum EventType{
		...
		DATABASE_INDEX_DEFRAGMENT_STARTED(EventLogSeverity.INFORMATIONAL, "System: Database indexes defragmented"),
		DATABASE_BACKUP_STARTED(EventLogSeverity.NOTICE, "System: Database backup completed"),
