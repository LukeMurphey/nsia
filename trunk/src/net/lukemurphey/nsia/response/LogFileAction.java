...
public class LogFileAction extends Action {
	...
	public static FieldLayout getLayout(){
		...
		// 1 -- Add the working directory field (the location of the executable to run)
		layout.addField( new FieldText("Message", "Message", 1, 5, new MessageValidator()) );
		
		// 2 -- Add the file field (the location of the file to append to)
		layout.addField( new FieldText("File", "File", 1, 1, new FileFieldValidator(false, false, true)) );
