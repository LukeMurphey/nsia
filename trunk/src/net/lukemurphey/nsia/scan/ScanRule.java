...
public abstract class ScanRule implements HashtableSerialization{
	...
	/*
	 * This exception indicates that a scan rule could not be loaded.
	 */
	...
	/*
	 * This exception indicates that a scan result could not be loaded.
	 */
	...
	/*
	 * This exception indicates that a scan rule could not be evaluated.
	 */
	...
	public Hashtable<String, Object> toHashtable(){
		...
		// 1 -- Create and populate the hashtable
	...
	public static boolean setScanDataObsolete(long ruleId) throws NoDatabaseConnectionException, SQLException{
		...
		// 1 -- Set the scan data to obsolete
		try {
			connection = Application.getApplication().getDatabaseConnection(DatabaseAccessType.SCANNER);
