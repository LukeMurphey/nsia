...
public class GraphServlet extends HttpServlet {
	...
	public synchronized void doRequest(HttpServletRequest request, HttpServletResponse response, int method ) throws ServletException, IOException {
		...
		try {
			sessionState = getSessionState( request, response, method);
	...
	private SessionStatus getSessionState(HttpServletRequest request, HttpServletResponse response, int httpMethod) throws GeneralizedException{
