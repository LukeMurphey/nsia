...
import net.lukeMurphey.nsia.scanRules.HttpResponseData;
import net.lukeMurphey.nsia.scanRules.InvalidDefinitionException;
import net.lukeMurphey.nsia.scanRules.ScriptClassLoader;
import net.lukeMurphey.nsia.scanRules.ScriptDefinition;
import net.lukeMurphey.nsia.scanRules.DefinitionEvaluationException;
import net.lukeMurphey.nsia.scanRules.Variables;
